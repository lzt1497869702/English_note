...
| 单词                     | 释义                                  | 举例                                                         |
| ------------------------ | ------------------------------------- | ------------------------------------------------------------ |
| sound<br/>`/saʊnd/`      | _n._ 声音；音响<br/>_v._ 听起来；发声 | The sound of the waves is soothing.<br/>（海浪的声音让人感到舒缓。） |
| found<br/>`/faʊnd/`      | _v._ 创立；建立；发现                 | She found a new way to solve the problem.<br/>（她找到了解决问题的新方法。） |
| round<br/>`/raʊnd/`      | _adj._ 圆的；全面的<br/>_n._ 圆形物   | The table is round.<br/>（这张桌子是圆形的。）               |
| abound<br/>`/əˈbaʊnd/`   | _v._ 大量存在；充满                   | Wildlife abounds in this area.<br/>（这个地区野生动物丰富。） |
| astound<br/>`/əˈstaʊnd/` | _v._ 使震惊；使惊愕                   | The magician's tricks astound the audience.<br/>（魔术师的把戏让观众震惊。） |
